							...
							while(serverText != null){
								...
								if (serverText.contentEquals("p")) {
									...
									if (CsvFileHelper.test().equals("null")) {
										rps = "Tu n'as rien à faire";
										out.println(rps);
										out.flush();
										System.out.println("Tu n'as rien à faire");
									}
									else {
										rps = "Délivrer le médicament : " + CsvFileHelper.test();
										out.println(rps);
										out.flush();
										System.out.println("Délivrer le médicament : " + CsvFileHelper.test());
										String response = "n";
